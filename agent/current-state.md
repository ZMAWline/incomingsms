...
- **Still open, date-gated:** delete the 41 unused live secrets on or after **2026-09-30** (`agent/secrets-inventory.md` "Live secrets no code reads"), and decide on the 105 secrets TEST lacks.
